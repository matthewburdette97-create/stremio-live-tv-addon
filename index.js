...
const DEFAULT_STREAMS = {
  ...
  'Japan': [
    { title: 'NHK World', url: 'https://live.nhkworld.jp/nhkworld.m3u8' },
    { title: 'NTV', url: 'https://live.ntv.co.jp/ntv.m3u8' },
    { title: 'Fuji TV', url: 'https://live.fujitv.co.jp/fujitv.m3u8' }
  ],
  'Jordan': [
  ...
  'USA': [
    ...
    { title: 'CBS', url: 'https://live.cbs.com/cbs.m3u8' },
    { title: 'FOX', url: 'https://live.fox.com/fox.m3u8' },
    { title: 'CNN', url: 'https://live.cnn.com/cnn.m3u8' }
  ],
  'Uruguay': [
...
if (require.main === module) {
  try {
    ...
    // Simple inline middleware to serve addon
    app.get('*', (req, res, next) => {
      console.log(`${req.method} ${req.path}`)
      next()
    })
    
    // Serve the addon using getRouter
